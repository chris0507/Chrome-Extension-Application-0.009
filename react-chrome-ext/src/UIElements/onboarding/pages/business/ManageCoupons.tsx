    ...
    <div className="p-4">
      <div className="flex justify-between items-center p-4">
        ...
        <div className="flex gap-2">
          <button className="flex items-center justify-between bg-[#932580] text-white px-2 pl-4 rounded-full" onClick={() => {navigate("/create-coupons")}}>
              ...
              <div className="flex justify-between items-center gap-5 border border-white rounded-2xl bg-[#232F3E] p-4">
                ...
                <div className="w-[70%]">
                  ...
                  <p className="text-white text-sm">
                    ...
                    elitr, sed diam nonumy eirmod temporividunt ut labore et
                    dolore magna aliquyam erat, sed diam vluptua.
                  </p>
                </div>
                <div className="flex flex-col justify-center items-center gap-3">
                  <p className="text-white text-xl mb-1">Cost 20 sch |</p>
                  <button className="flex items-center justify-between bg-[#932580] px-2 pl-5 rounded" onClick={() => {navigate("/edit-coupon")}}>
                    <span className="py-1 pr-2 text-white">Edit coupon</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
