...
const SignUpForm = () => {
  ...
  const options = {
    ...
    theme: {
      ...
      input: "bg-[#343434] dark:bg-[#343434]",
      inputIcon: "",
      selected: "",
    },
    icons: {
    ...
    <div className="w-full max-w-xs">
      ...
      <form className="pb-8 mb-4 w-8/12" onSubmit={handleSubmit(submitForm)}>
        ...
        <div className="mb-3">
          <select
            id="city"
            className="bg-[#3FA9F5] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400 dark:text-white"
          >
