  ...
  return (
    ...
    <div className="fixed inset-0 bg-black bg-opacity-95 z-50 overflow-auto">
      <div className="float-right m-5">
        <svg
          className="h-6 w-6 text-white border border-white rounded-full cursor-pointer"
      ...
      <div className="flex justify-between items-center m-5 p-10">
        <div className="flex flex-col w-[35%] mr-5">
          <div className="flex justify-center items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 508.97 441.88"
              className="w-[130px] mb-3"
            >
              <path
